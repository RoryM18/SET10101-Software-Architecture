...
public class KWICShiftLineThread extends Thread
{
	private PipedReader pipeOut;
	private PipedWriter pipeIn;
	
	KWICShiftLineThread(PipedReader pipeOut, PipedWriter pipeIn)
	{
	...
	public void run()
	{
		try
		{
			//The incoming pipe will send stings. Simplest method is to buffer the pipe.
